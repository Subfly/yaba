//
//  EPUBDocmarkCreationContent.swift
//  YABA
//
//  EPUB document bookmark creation (ZIP-backed cover image for bookmark preview; in-app reading uses Readium).
//

import SwiftUI
import UniformTypeIdentifiers

struct EPUBDocmarkCreationContent: View {
    @Environment(\.dismiss)
    private var dismiss
        ...
        List {
            Section {
                ...
                Button {
                    ...
                    Label {
                        Text(String(localized: "Bookmark Creation Pick EPUB Document Action"))
                    } icon: {
